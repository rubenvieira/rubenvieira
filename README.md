...
<!-- repos -->
- [**minimax-quota-bar**](https://github.com/rubenvieira/minimax-quota-bar)  - A premium macOS menu bar app that displays your MiniMax API quota usage in real-time with a zero-border Notch HUD. ⭐ 3
